...
experiments = c('SRR1232072','SRR1232073')

for(experiment in experiments) {
  f1 = paste(data_dir,"/validation_FlaiMapper_miRBase_SRP041082_",experiment,"_sensitivity.txt",sep="")
  f2 = paste(data_dir,"/validation_FlaiMapper_miRBase_SRP041082_",experiment,"_offset.txt",sep="")
  
  f3 = paste(output_dir_extra,"/validation_FlaiMapper_miRBase_SRP041082_",experiment,"_sensitivity_barplot.svg",sep="")
  f4 = paste(output_dir_extra,"/validation_FlaiMapper_miRBase_SRP041082_",experiment,"_sensitivity_piechart.svg",sep="")
  
  f5 = paste(output_dir_extra,"/validation_FlaiMapper_miRBase_SRP041082_",experiment,"_offset_with_miRBase_start-positions.svg",sep="")
  f6 = paste(output_dir_extra,"/validation_FlaiMapper_miRBase_SRP041082_",experiment,"_offset_with_miRBase_stop-positions.svg",sep="")
